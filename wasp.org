...
#+END_SRC
* button UI menu was very bad before

#+BEGIN_SRC css
.vertical-tab-nav-item.is-active, button.mod-cta {
    background-color: var(--button-bg-color); /* Default background color */
    color: var(--button-text-color); /* Default text color */
}

.vertical-tab-nav-item.is-active:hover, button.mod-cta:hover,
.vertical-tab-nav-item.is-active:focus, button.mod-cta:focus {
