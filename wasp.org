...
- [[#wasp-primary--everything-else][Wasp Primary / Everything Else]]
  ...
  - [[#tags-in-editing-needs-to-be-together-with-the-one-in-preview][tags in editing (needs to be together with the one in preview)]]
...
** tags in editing (needs to be together with the one in preview)
[[https://forum.obsidian.md/t/meta-post-common-css-hacks/1978/64?u=santi][Meta Post - Common CSS Hacks - Share & showcase - Obsidian Forum]]
#+BEGIN_SRC css
